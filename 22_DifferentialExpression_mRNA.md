# Generate differential expression from all SCN RNASEQ using mRNAs

There is a need to see expression differences at a finite level between mRNAs, rather than genes, which impacts read "uniqueness".
...
unlink 1703FL-02-01_S1_L001_R1_001.fastqmRNA_counts_genes.txt
ln -s ../../38_Expression/01_AllExpressionDatasetsSeparate/1703FL-02-01_S1_L001_R1_001.fastqmRNA_counts_genes.txt 1703FL-02-01_S1_L001_R1_001_val_1.fqmRNA_counts_genes.txt
```
...
ml r-deseq2/1.20.0-py2-r3.5-openmpi3-zhebatp
 ...
 -- replacing outliers and refitting for 632 genes
...
awk '$3=="mRNA"' OrderedSCNGenePredictions.gff3 |cut -f 9 |sed 's/ID=//g' |sed 's/;/\t/g' |awk '{print $1"\tN/A"}' >AllmRNAsNA
